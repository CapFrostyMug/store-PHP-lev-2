...
<div class="container">
    <footer class="py-3 my-4">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            ...
            <li class="nav-item"><a href="/good/catalog" class="nav-link px-2 text-muted">Каталог</a></li>
            <li class="nav-item"><a href="/cart" class="nav-link px-2 text-muted">Корзина</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-2 text-muted">Вопросы</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-2 text-muted">О нас</a></li>
        </ul>
        <p class="text-center text-muted">&copy; <?php echo date('Y') ?> Company, Inc</p>
    </footer>
</div>
